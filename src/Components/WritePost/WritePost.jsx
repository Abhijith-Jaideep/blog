...
const WritePost = () => {
  ...
  return (
    <div className={`writepost h-100 bg-${mode} text-${mode === "light" ? "dark" : "light"}`}>
          ...
          <form onSubmit={submit}>
            ...
            <div className="details">
              ...
              <div style={{ display: "flex", justifyContent: "center" }}>
                <button type="submit" className="btn w-50 p-2 " style={{ borderRadius: "16px", fontWeight: "bold", backgroundColor: "darkturquoise" }}>Publish</button>
              </div>
